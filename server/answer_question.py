...
def get_answer_from_files(question, session_id, pinecone_index):
    """
    Get answers to a given question using the specified Pinecone index and session ID.
    The function first searches for relevant files and then generates answers using ChatGPT.

    Args:
        question (str): The question to answer.
        session_id (str): The session ID for the current user.
        pinecone_index (PineconeIndex): The Pinecone index object.

    Returns:
        flask.Response: A JSON response containing the answers generated by Pinecone and ChatGPT.
    """
    ...
    try:
        # Query the Pinecone index for relevant file chunks
        ...
        # Create a string of file extracts for the GPT prompt
        files_string = ""
        ...
        # Create the GPT prompt using the question and the file extracts
        prompt = (
        ...
        # Extract the generated answer and save it to the database
    ...
    # Get an answer directly from ChatGPT
    try:
    ...
    # Return the generated answers as a JSON response
